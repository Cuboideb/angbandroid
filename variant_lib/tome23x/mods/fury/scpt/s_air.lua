...
ELECBALL = add_spell
{
	...
	["spell"] =     function()
		...
		ret, dir = get_aim_dir()
		if ret == FALSE then return end
		return fire_ball(GF_ELEC, dir, 20 + get_level(ELECBALL, 500), 2 + get_level(ELECBALL, 5))
	end,
	["info"] =      function()
		return "dam "..(20 + get_level(ELECBALL, 500)).." rad "..(2 + get_level(ELECBALL, 5))
	end,
	["desc"] =      {
			"Conjures a ball of electricity to burn your foes to ashes",
