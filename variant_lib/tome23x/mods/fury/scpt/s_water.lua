...
ICEBALL = add_spell
{
	...
	["spell"] =     function()
		...
		return fire_ball(GF_COLD, dir, 20 + get_level(ICEBALL, 500), 2 + get_level(ICEBALL, 5))
	end,
	["info"] =      function()
		return "dam "..(20 + get_level(ICEBALL, 500)).." rad "..(2 + get_level(ICEBALL, 5))
	end,
	["desc"] =      {
			"Conjures a ball of ICE to FREEZE your foes",
