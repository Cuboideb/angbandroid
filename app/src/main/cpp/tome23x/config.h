 ...
 */
#if defined(_POSIX_SAVED_IDS) && !(defined(SUNOS) && !defined(SOLARIS)) && !defined(__APPLE__) && !defined(ANDROID)
 ...
 */
#if defined(SET_UID) && !defined(MACH_O_CARBON) && !defined(NO_HOME_TOME) && !defined(ANDROID)
 ...
 */
#if defined(SET_UID) && !defined(MACH_O_CARBON) && !defined(ANDROID)
