...
/* get function: stat of class  bonuses_type */
static int toluaI_get_object_bonuses_type_stat(lua_State* tolua_S)
{
 int toluaI_index;
 TOLUA_ARRAY_SELF(bonuses_type);
 TOLUA_ARRAY_INDEX("bonuses_type: stat",6);
 tolua_pushnumber(tolua_S,(long)self->stat[toluaI_index]);
 return 1;
}

/* set function: stat of class  bonuses_type */
static int toluaI_set_object_bonuses_type_stat(lua_State* tolua_S)
{
 int toluaI_index;
 TOLUA_ARRAY_SELF(bonuses_type);
 TOLUA_ARRAY_INDEX("bonuses_type: stat",6);
  self->stat[toluaI_index] = ((int)  tolua_getnumber(tolua_S,3,0));
 return 0;
}

/* get function: sp_bonus of class  bonuses_type */
static int toluaI_get_object_bonuses_type_sp_bonus(lua_State* tolua_S)
{
  TOLUA_GET_SELF(bonuses_type);
  tolua_pushnumber(tolua_S,(long)self->sp_bonus);
 return 1;
}

/* set function: sp_bonus of class  bonuses_type */
static int toluaI_set_object_bonuses_type_sp_bonus(lua_State* tolua_S)
{
  TOLUA_GET_SELF(bonuses_type);
  if (!tolua_istype(tolua_S,2,LUA_TNUMBER,0))
   TOLUA_ERR_ASSIGN;
...
/* get function: skills of class  bonuses_type */
static int toluaI_get_object_bonuses_type_skills(lua_State* tolua_S)
{
 int toluaI_index;
 TOLUA_ARRAY_SELF(bonuses_type);
 TOLUA_ARRAY_INDEX("bonuses_type: skills",MAX_SKILL);
 tolua_pushnumber(tolua_S,(long)self->skills[toluaI_index]);
 return 1;
}

/* set function: skills of class  bonuses_type */
static int toluaI_set_object_bonuses_type_skills(lua_State* tolua_S)
{
 int toluaI_index;
 TOLUA_ARRAY_SELF(bonuses_type);
 TOLUA_ARRAY_INDEX("bonuses_type: skills",MAX_SKILL);
  self->skills[toluaI_index] = ((int)  tolua_getnumber(tolua_S,3,0));
 return 0;
}

/* get function: see_infra of class  bonuses_type */
static int toluaI_get_object_bonuses_type_see_infra(lua_State* tolua_S)
{
  TOLUA_GET_SELF(bonuses_type);
...
/* set function: see_infra of class  bonuses_type */
static int toluaI_set_object_bonuses_type_see_infra(lua_State* tolua_S)
{
  TOLUA_GET_SELF(bonuses_type);
  if (!tolua_istype(tolua_S,2,LUA_TNUMBER,0))
   TOLUA_ERR_ASSIGN;
  self->see_infra = ((int)  tolua_getnumber(tolua_S,2,0));
 return 0;
}

/* get function: pspeed of class  bonuses_type */
static int toluaI_get_object_bonuses_type_pspeed(lua_State* tolua_S)
{
  TOLUA_GET_SELF(bonuses_type);
...
/* set function: pspeed of class  bonuses_type */
static int toluaI_set_object_bonuses_type_pspeed(lua_State* tolua_S)
{
  TOLUA_GET_SELF(bonuses_type);
  if (!tolua_istype(tolua_S,2,LUA_TNUMBER,0))
   TOLUA_ERR_ASSIGN;
  self->pspeed = ((int)  tolua_getnumber(tolua_S,2,0));
 return 0;
}

/* get function: extra_blows of class  bonuses_type */
static int toluaI_get_object_bonuses_type_extra_blows(lua_State* tolua_S)
{
  TOLUA_GET_SELF(bonuses_type);
...
/* set function: extra_blows of class  bonuses_type */
static int toluaI_set_object_bonuses_type_extra_blows(lua_State* tolua_S)
{
  TOLUA_GET_SELF(bonuses_type);
  if (!tolua_istype(tolua_S,2,LUA_TNUMBER,0))
   TOLUA_ERR_ASSIGN;
  self->extra_blows = ((int)  tolua_getnumber(tolua_S,2,0));
 return 0;
}

/* get function: extra_shots of class  bonuses_type */
static int toluaI_get_object_bonuses_type_extra_shots(lua_State* tolua_S)
{
  TOLUA_GET_SELF(bonuses_type);
...
/* set function: extra_shots of class  bonuses_type */
static int toluaI_set_object_bonuses_type_extra_shots(lua_State* tolua_S)
{
  TOLUA_GET_SELF(bonuses_type);
  if (!tolua_istype(tolua_S,2,LUA_TNUMBER,0))
   TOLUA_ERR_ASSIGN;
  self->extra_shots = ((int)  tolua_getnumber(tolua_S,2,0));
 return 0;
}
...
static int toluaI_object_item_tester_hook_tval00(lua_State* tolua_S)
{
     ...
     !tolua_isnoobj(tolua_S,3))
 {
  ...
  const object_type* o_ptr = ((const object_type*)  tolua_getusertype(tolua_S,1,0));
  byte tval = ((byte)  tolua_getnumber(tolua_S,2,0));
  bool toluaI_ret = (bool)  item_tester_hook_tval(o_ptr,tval);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}
...
int tolua_object_open (lua_State* tolua_S)
{
 ...
 TOLUA_DEF(TV_ANY);
 TOLUA_DEF(TV_SKELETON);
 TOLUA_DEF(TV_BOTTLE);
 TOLUA_DEF(TV_JUNK);
 TOLUA_DEF(TV_SPIKE);
 TOLUA_DEF(TV_CHEST);
 TOLUA_DEF(TV_FIGURINE);
 TOLUA_DEF(TV_STATUE);
 TOLUA_DEF(TV_SHOT);
 TOLUA_DEF(TV_ARROW);
 TOLUA_DEF(TV_BOLT);
 TOLUA_DEF(TV_BOW);
 TOLUA_DEF(TV_DIGGING);
 TOLUA_DEF(TV_HAFTED);
 TOLUA_DEF(TV_POLEARM);
 TOLUA_DEF(TV_SWORD);
 TOLUA_DEF(TV_BOOTS);
 TOLUA_DEF(TV_GLOVES);
 TOLUA_DEF(TV_HELM);
 ...
 TOLUA_DEF(TV_SHIELD);
 TOLUA_DEF(TV_CLOAK);
 TOLUA_DEF(TV_SOFT_ARMOR);
 TOLUA_DEF(TV_HARD_ARMOR);
 TOLUA_DEF(TV_DRAG_ARMOR);
 TOLUA_DEF(TV_LITE);
 TOLUA_DEF(TV_AMULET);
 TOLUA_DEF(TV_RING);
 TOLUA_DEF(TV_STAFF);
 ...
 TOLUA_DEF(TV_FLASK);
 TOLUA_DEF(TV_FOOD);
 TOLUA_DEF(TV_LIFE_BOOK);
 TOLUA_DEF(TV_SORCERY_BOOK);
 TOLUA_DEF(TV_NATURE_BOOK);
 TOLUA_DEF(TV_CHAOS_BOOK);
 TOLUA_DEF(TV_DEATH_BOOK);
 TOLUA_DEF(TV_TRUMP_BOOK);
 TOLUA_DEF(TV_ARCANE_BOOK);
 TOLUA_DEF(TV_GOLD);
 TOLUA_DEF(TV_BOOKS_MIN);
 TOLUA_DEF(TV_BOOKS_MAX);
 ...
 TOLUA_DEF(TR3_WILD_SHOT);
 TOLUA_DEF(TR3_WILD_WALK);
 TOLUA_DEF(TR3_EASY_ENCHANT);
 TOLUA_DEF(TR3_XXX5);
 TOLUA_DEF(TR3_XXX6);
 TOLUA_DEF(TR3_XXX7);
 TOLUA_DEF(TR3_XXX8);
 ...
 tolua_cclass(tolua_S,"bonuses_type","");
 tolua_tablearray(tolua_S,"bonuses_type","stat",toluaI_get_object_bonuses_type_stat,toluaI_set_object_bonuses_type_stat);
 tolua_tablevar(tolua_S,"bonuses_type","sp_bonus",toluaI_get_object_bonuses_type_sp_bonus,toluaI_set_object_bonuses_type_sp_bonus);
 tolua_tablearray(tolua_S,"bonuses_type","skills",toluaI_get_object_bonuses_type_skills,toluaI_set_object_bonuses_type_skills);
 tolua_tablevar(tolua_S,"bonuses_type","see_infra",toluaI_get_object_bonuses_type_see_infra,toluaI_set_object_bonuses_type_see_infra);
...
void tolua_object_close (lua_State* tolua_S)
{
 ...
 TOLUA_UNDEF(TV_ANY);
 TOLUA_UNDEF(TV_SKELETON);
 TOLUA_UNDEF(TV_BOTTLE);
 TOLUA_UNDEF(TV_JUNK);
 TOLUA_UNDEF(TV_SPIKE);
 TOLUA_UNDEF(TV_CHEST);
 TOLUA_UNDEF(TV_FIGURINE);
 TOLUA_UNDEF(TV_STATUE);
 TOLUA_UNDEF(TV_SHOT);
 TOLUA_UNDEF(TV_ARROW);
 TOLUA_UNDEF(TV_BOLT);
 TOLUA_UNDEF(TV_BOW);
 TOLUA_UNDEF(TV_DIGGING);
 TOLUA_UNDEF(TV_HAFTED);
 TOLUA_UNDEF(TV_POLEARM);
 TOLUA_UNDEF(TV_SWORD);
 TOLUA_UNDEF(TV_BOOTS);
 TOLUA_UNDEF(TV_GLOVES);
 TOLUA_UNDEF(TV_HELM);
 TOLUA_UNDEF(TV_CROWN);
 TOLUA_UNDEF(TV_SHIELD);
 TOLUA_UNDEF(TV_CLOAK);
 TOLUA_UNDEF(TV_SOFT_ARMOR);
 TOLUA_UNDEF(TV_HARD_ARMOR);
 TOLUA_UNDEF(TV_DRAG_ARMOR);
 TOLUA_UNDEF(TV_LITE);
 TOLUA_UNDEF(TV_AMULET);
 TOLUA_UNDEF(TV_RING);
 TOLUA_UNDEF(TV_STAFF);
 TOLUA_UNDEF(TV_WAND);
 TOLUA_UNDEF(TV_ROD);
 TOLUA_UNDEF(TV_SCROLL);
 TOLUA_UNDEF(TV_POTION);
 TOLUA_UNDEF(TV_FLASK);
 TOLUA_UNDEF(TV_FOOD);
 TOLUA_UNDEF(TV_LIFE_BOOK);
 TOLUA_UNDEF(TV_SORCERY_BOOK);
 TOLUA_UNDEF(TV_NATURE_BOOK);
 TOLUA_UNDEF(TV_CHAOS_BOOK);
 TOLUA_UNDEF(TV_DEATH_BOOK);
 TOLUA_UNDEF(TV_TRUMP_BOOK);
 TOLUA_UNDEF(TV_ARCANE_BOOK);
 TOLUA_UNDEF(TV_GOLD);
 TOLUA_UNDEF(TV_BOOKS_MIN);
 TOLUA_UNDEF(TV_BOOKS_MAX);
 ...
 TOLUA_UNDEF(TR3_WILD_SHOT);
 TOLUA_UNDEF(TR3_WILD_WALK);
 TOLUA_UNDEF(TR3_EASY_ENCHANT);
