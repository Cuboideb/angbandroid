...
static int toluaI_get_player_disturb_minor(lua_State* tolua_S)
{
...
static int toluaI_set_player_disturb_minor(lua_State* tolua_S)
{
  if (!tolua_istype(tolua_S,1,tolua_tag(tolua_S,"bool"),0))
   TOLUA_ERR_ASSIGN;
...
static int toluaI_get_player_adj_str_wgt(lua_State* tolua_S)
{
 int toluaI_index;
 TOLUA_ARRAY_INDEX("adj_str_wgt",40);
...
/* function: disturb */
static int toluaI_player_disturb00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,tolua_tag(tolua_S,"bool"),0) ||
     !tolua_isnoobj(tolua_S,2))
 {
  TOLUA_ERR_FN(disturb);
 } else {
  bool stop_search = ((bool)  tolua_getbool(tolua_S,1,0));
  disturb(stop_search);
 }
 return 0;
}

/* function: move_dun_level */
static int toluaI_player_move_dun_level00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_isnoobj(tolua_S,2))
 {
  TOLUA_ERR_FN(move_dun_level);
 } else {
  int direction = ((int)  tolua_getnumber(tolua_S,1,0));
  move_dun_level(direction);
 }
 return 0;
}

/* function: count_mutations */
static int toluaI_player_count_mutations00(lua_State* tolua_S)
{
 if (!tolua_isnoobj(tolua_S,1))
 {
  TOLUA_ERR_FN(count_mutations);
 } else {
  int toluaI_ret = (int)  count_mutations();
  tolua_pushnumber(tolua_S,(long)toluaI_ret);
 }
 return 1;
}

/* function: gain_mutation */
static int toluaI_player_gain_mutation00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_isnoobj(tolua_S,2))
 {
  TOLUA_ERR_FN(gain_mutation);
 } else {
  int choose_mut = ((int)  tolua_getnumber(tolua_S,1,0));
  bool toluaI_ret = (bool)  gain_mutation(choose_mut);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}

/* function: lose_mutation */
static int toluaI_player_lose_mutation00(lua_State* tolua_S)
{
 if (!tolua_istype(tolua_S,1,LUA_TNUMBER,0) ||
     !tolua_isnoobj(tolua_S,2))
 {
  TOLUA_ERR_FN(lose_mutation);
 } else {
  int choose_mut = ((int)  tolua_getnumber(tolua_S,1,0));
  bool toluaI_ret = (bool)  lose_mutation(choose_mut);
  tolua_pushbool(tolua_S,(int)toluaI_ret);
 }
 return 1;
}
...
int tolua_player_open (lua_State* tolua_S)
{
 ...
 TOLUA_FUN(disturb,toluaI_player_disturb00);
 TOLUA_FUN(move_dun_level,toluaI_player_move_dun_level00);
 TOLUA_FUN(count_mutations,toluaI_player_count_mutations00);
 TOLUA_FUN(gain_mutation,toluaI_player_gain_mutation00);
 TOLUA_FUN(lose_mutation,toluaI_player_lose_mutation00);
 return 1;
}
/* Close function */
void tolua_player_close (lua_State* tolua_S)
{
 ...
 lua_pop(tolua_S,1);
 lua_getglobals(tolua_S);
 lua_pushstring(tolua_S,"disturb_minor"); lua_pushnil(tolua_S); lua_rawset(tolua_S,-3);
 lua_pop(tolua_S,1);
 ...
 TOLUA_UNDEF(disturb);
 TOLUA_UNDEF(move_dun_level);
 TOLUA_UNDEF(count_mutations);
 TOLUA_UNDEF(gain_mutation);
 TOLUA_UNDEF(lose_mutation);
}
